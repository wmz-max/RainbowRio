...
module	wbqspiflash #(
		...
		input	wire		wbm_spi_cyc_i, wbm_spi_stb_i, wbm_spi_we_i,
		input	wire	[(AW-1):0]	wbm_spi_addr_i,
		input	wire	[WB_DAT_WIDTH-1:0]	wbm_spi_wdata_i,
		input [(WB_DAT_WIDTH/8)-1:0] wbm_spi_sel_i,
		// then outputs
		output	reg		o_wb_stall,
		output	reg		spi_wbm_ack_o,
		output	reg	[WB_DAT_WIDTH-1:0]	spi_wbm_rdata_o,
